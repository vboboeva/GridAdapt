...
def main():
	...
	for step in range(n_steps):
		...
		# print('r', r)
		# print('\n')
		h = np.dot(J, r)#/N_I # normalization of the weights breaks the optimization of theta and g...
		...
		print(step)
		print(f'a = {a:.5f},   s = {s:.5f},   delta_a = {delta_a:.2f},   delta_s = {delta_s:.2f},  theta = {theta:.2f},   g = {g:.2f}')
		...
		# this part of the code breaks the optimization of theta and g...
